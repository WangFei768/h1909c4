...
<body class="gray-bg">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="inStu.htm" enctype="multipart/form-data">
					...
					<form id="form_user" method="post" action="reserveStu.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<input type="checkbox" name="hobbys" value="做美食">做美食
								</td>
	...
	function initEditUser(getSelection){
		...
		/* $('input[name="hobbys"]').prop("checked",false) */
